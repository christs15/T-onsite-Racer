...
const routes = [
    {
        ...
        children: [
            {
                path: "steuerung",
                loadChildren: () => __webpack_require__.e(/*! import() | pages-steuerung-steuerung-module */ "pages-steuerung-steuerung-module").then(__webpack_require__.bind(null, /*! ../pages/steuerung/steuerung.module */ "./src/app/pages/steuerung/steuerung.module.ts")).then(m => m.SteuerungPageModule)
            },
            {
                path: "onsite",
                loadChildren: () => __webpack_require__.e(/*! import() | pages-onsite-onsite-module */ "pages-onsite-onsite-module").then(__webpack_require__.bind(null, /*! ../pages/onsite/onsite.module */ "./src/app/pages/onsite/onsite.module.ts")).then(m => m.OnsitePageModule)
            }
        ]
    }
];
