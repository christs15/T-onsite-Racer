...
var SteuerungPageModule = /** @class */ (function () {
    function SteuerungPageModule() {
    }
...
var SteuerungPage = /** @class */ (function () {
    function SteuerungPage(ble, alertCtrl, ngZone, toastCtrl, router, loadingController) {
        this.ble = ble;
    ...
    SteuerungPage.prototype.presentLoadingWithOptions = function () {
    ...
    SteuerungPage.prototype.Scan = function () {
        var _this = this;
        this.devices = ['ae975c80-05f0-11ea-8d71-362b9e155667'];
        this.checkBluetooth();
        if (this.connected === false) {
            this.ble.isEnabled().then(function (success) {
            ...
            function (device) { return _this.onDeviceDiscovered(device); });
        }
        else {
            //Discconect Device
            this.connectbutton = "Connect to Car";
            this.ble.disconnect(this.peripheral.id).then(function (device) { return _this.onDeviceDisconnected(device); }, function (device) { return _this.scanError(""); });
            this.showBleDisconnected("You are Disconnected from the T-Racer");
        }
    };
    SteuerungPage.prototype.checkBluetooth = function () {
        var _this = this;
        this.ble.isEnabled().then(function (success) {
            _this.showToast("Bluetooth is enabled");
        }, function (error) {
            _this.showError("Bluetooth is not enabled");
        });
    };
    //creats a popup with a bluetooth disconnect message
    SteuerungPage.prototype.showBleDisconnected = function (msg) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
    ...
    SteuerungPage.prototype.showError = function (error) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    SteuerungPage.prototype.showToast = function (msj) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var toast;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    SteuerungPage.prototype.scanError = function (error) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var toast;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    SteuerungPage.prototype.onDeviceDiscovered = function (device) {
        console.debug('Discovered' + JSON.stringify(device, null, 2));
        this.connect2Device(device);
        this.connectbutton = "Disconnect Car";
    };
    SteuerungPage.prototype.connect2Device = function (device) {
        var _this = this;
    ...
    SteuerungPage.prototype.onConnected = function (peripheral) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var toast, _i, _a, i, joystickSpeed, joystickSteer;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        for (_i = 0, _a = peripheral.characteristics; _i < _a.length; _i++) {
                            i = _a[_i];
                            console.log("Characteristic: " + JSON.stringify(i));
                        }
                        this.jsSpeed.destroy();
                        this.jsSteer.destroy();
                        joystickSpeed = Object(nipplejs__WEBPACK_IMPORTED_MODULE_5__["create"])({
                            mode: 'static',
                            color: 'black',
                            fadeTime: 255,
                            size: this.size,
                        ...
                        joystickSteer = Object(nipplejs__WEBPACK_IMPORTED_MODULE_5__["create"])({
                            mode: 'static',
                            color: 'black',
                            fadeTime: 255,
                            size: this.size,
                        ...
                        this.jsSpeed.on('end', function (event, data) { return _this.stop_motor(event, data); });
                        this.jsSpeed.on('move', function (event, data) { return _this.move_speed(event, data); });
                        this.jsSteer.on('end', function (event, data) { return _this.steer_straighton(event, data); });
                        this.jsSteer.on('move', function (event, data) { return _this.move_steer(event, data); });
                        return [2 /*return*/];
                }
            });
        });
    };
    SteuerungPage.prototype.onDeviceDisconnected = function (peripheral) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    SteuerungPage.prototype.sendValue = function () {
    ...
    SteuerungPage.prototype.stringToBytes = function (string) {
    ...
    SteuerungPage.prototype.ngAfterViewInit = function () {
    ...
    //stop car
    SteuerungPage.prototype.stop_motor = function (event, data) {
        var speed = 128;
        this.speed = +speed;
        this.sendValue();
    ...
    SteuerungPage.prototype.steer_straighton = function (event, data) {
        var steer = 90;
        this.steer = +steer;
        this.sendValue();
        console.log("steering car: straight on " + steer);
    };
    SteuerungPage.prototype.move_speed = function (event, data) {
    ...
    SteuerungPage.prototype.move_steer = function (event, data) {
        var nip_size = this.size;
        var max_rangeX = 0;
        var min_rangeX = 180;
        if (((data.angle.degree < 90) && (data.angle.degree >= 0)) || ((data.angle.degree < 360) && (data.angle.degree > 270))) {
    ...
    SteuerungPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-steuerung-steuerung-module-es5.js.map