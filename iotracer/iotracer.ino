...
class CharacteristicCallbacks: public BLECharacteristicCallbacks {
    ...
    void onWrite(BLECharacteristic* pCharacteristic) {
      ...
      int steer = svalue.substring(splitindex+1).toInt(); //get steer value
      //call motorcontroll function
      Serial.print("value received speed:  ");
      Serial.print(speed);
      Serial.print("  steer: ");
      Serial.println(steer);
 
     carControl(steer, speed); //send values to mottors
    }
};
